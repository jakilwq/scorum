...
struct proposal_evaluator_impl
    : public evaluator_impl<committee_factory, proposal_evaluator_impl<OperationType>, protocol::proposal_operations>
{
    typedef OperationType operation_type;

    proposal_evaluator_impl(committee_factory& factory)
        : evaluator_impl<committee_factory, proposal_evaluator_impl<OperationType>, protocol::proposal_operations>(
              factory)
    {
    }
...
template <typename OperationType>
struct proposal_invite_evaluator : public proposal_evaluator_impl<OperationType>
{
    typedef OperationType operation_type;
