...
{
    return _impl->get_trending_tags(after_tag, limit);
    //    try
    //    {
...
{
    return _impl->get_tags_used_by_author(author);
    //    try
    //    {
...
{
    return _impl->get_tags_by_category(domain, category);
    //    try
    //    {
...
{
    return _impl->get_discussions_by_trending(query);
    //    try
    //    {
...
{
    return _impl->get_discussions_by_created(query);
    //    try
    //    {
...
{
    return _impl->get_discussions_by_hot(query);
    //    try
    //    {
...
{
    return _impl->get_content(author, permlink);
    //    try
    //    {
...
{
    return _impl->get_comments(parent_author, parent_permlink, depth);
    //    try
    //    {
...
{
    return _impl->get_discussions_by_author(query);
    //    try
    //    {
